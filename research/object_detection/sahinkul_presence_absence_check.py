...
WORKS_NAME = "sahinkul_presence_absence_check"

MODEL_NAME = 'trained_models/' + WORKS_NAME
...
video_writer.open("test_videos/" + str(WORKS_NAME) + ".avi", video_type, 25.0,
    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            while ret:
                ...
                out = cv2.resize(image_np, (vis_resize_w, vis_resize_h))
                ...
                if 460 < img_count < 600:
                    color = color_red
                elif 760 < img_count < 820:
                    color = color_red
                else:
                    color = color_move_on
